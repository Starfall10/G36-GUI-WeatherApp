    ...
    <div className="tempContainer">
      <div className="hourlyTemp">
        ...
        <div className="content">
          <div className="card">
            <WeatherIcon condition="cloudy" size="clamp(2rem, 25%, 3rem)" />
          ...
          <div className="card">
            <WeatherIcon condition="foggy" size="clamp(2rem, 25%, 3rem)" />
          ...
          <div className="card">
            <WeatherIcon condition="tornado" size="clamp(2rem, 25%, 3rem)" />
